...
PYTHONUNBUFFRED=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='debiasing' \
    trainer.experiment_name='qwen2_5_vl_3b_debiasing_v19' \
    ...
    actor_rollout_ref.rollout.multi_turn.interaction_config_path=/data/wangnn/repos/verl/debiasing/waterbird_interaction2.yaml $@
# actor_rollout_ref.actor.grad_clip=1.0 \
# kl约束
# entropy_coenf