...
PYTHONUNBUFFRED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.weight_by_group=False \
    ...
    actor_rollout_ref.rollout.mem-fraction-static=0.65\
    ...
    actor_rollout_ref.rollout.calculate_tokens_log_probs=False \
    actor_rollout_ref.ref.log_prob_micro_batch_size_per_gpu=2 \
    actor_rollout_ref.ref.fsdp_config.param_offload=True \
    custom_reward_function.path=/data/wangnn/repos/verl/debiasing/waterbird_reward_func_dummpy.py \
    algorithm.use_kl_in_reward=False \
    trainer.critic_warmup=0 \
    trainer.logger='["console","swanlab"]' \
    trainer.project_name='debiasing_debug' \
    trainer.experiment_name='qwen2_5_vl_3b_debiasing_debug_t4' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=100 \
    trainer.test_freq=1001 \
