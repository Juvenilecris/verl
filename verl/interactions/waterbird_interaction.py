...
class WaterbirdInteraction(BaseInteraction):
    ...
    Step 2: Now, using the cropped image <image> of (based on your previous bounding box) provided, classify the bird as either a "Waterbird" or a "Landbird". Provide your classification result in the format <answer>Waterbird or Landbird</answer>."""
